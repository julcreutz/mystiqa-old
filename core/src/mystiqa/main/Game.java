...
public class Game extends ApplicationAdapter {
	...
	public static ShaderProgram colorToAbsolute(Color c) {
	...
	public static ShaderProgram colorToAdditive(Color c) {
	...
	public static ShaderProgram colorToSubtractive(Color c) {
		if (relativeShaders == null) {
			relativeShaders = new HashMap<Color, ShaderProgram>();
		}
	...
	public static ShaderProgram colorToRelative(Color c) {
		if (relativeShaders == null) {
			relativeShaders = new HashMap<Color, ShaderProgram>();
		}
