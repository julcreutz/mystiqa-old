...
public class Noise {
    ...
    public static class Parameters {
        /** The number of octaves. The higher, the rougher. */
        public int octaves;
        /** The frequency. The higher, the noisier. */
        public float frequency;
        /** The persistence. The higher, the rougher. Should stay between zero and one. */
        public float persistence;

        /**
         * Constructs a new instance with all values.
         *
    ...
    /**
     * Constructs a new instance and generates gradient vectors using given {@link Random}
     ...
     *
     * The total noise value is calculated by layering each octave's noise value. Each value
    ...
    /**
     * Returns the base noise value for the given coordinates.
     *
