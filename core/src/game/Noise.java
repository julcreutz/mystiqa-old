...
public class Noise {
    ...
    public static class Parameters {
        ...
        public int octaves;
        /** The frequency. The higher, the noisier. */
        public float frequency;
        /** The persistence. The higher, the rougher. Should ideally stay between zero and one. */
    ...
    /**
     * Constructs new instance and generates gradient vectors using given {@link Random} random number generator.
     *
    ...
    /**
     * Returns the combined noise value of the given parameters at the specified coordinates.
     *
     * The total noise value is calculated by layering each octave's noise value. Each value is multiplied by an
     * amplitude starting at one.
     *
     * For each successive octaves the amplitude is halved and the frequency doubled, which creates the typical noise
     * pattern.
     *
    ...
    /**
     * Returns the base noise value for given coordinates.
     *
     * To calculate the noise value, first the dot product of each corner cell's gradient vector, generated by
     * {@link #Noise(Random)}, and the given coordinates is calculated. The final noise value is the bilinear
     * interpolation of each dot product and the given coordinates.
     *
     * @param x x coordinate
     * @param y y coordinate
    ...
    /**
     * Interpolates between two values. This was originally suggested by Ken Perlin to improve noise continuity.
     *
